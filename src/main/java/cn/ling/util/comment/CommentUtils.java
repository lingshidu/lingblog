package cn.ling.util.comment;

import cn.ling.config.properties.BlogProperties;
import cn.ling.constant.PageConstants;
...
import cn.ling.util.*;
import cn.ling.util.comment.channel.ChannelFactory;
import cn.ling.util.comment.channel.CommentNotifyChannel;
...
public class CommentUtils {
     ...
     */
    public void judgeSendNotify(CommentDTO commentDTO, boolean isVisitorComment, cn.ling.entity.Comment parentComment) {
     ...
     * @param commentDTO    当前收到的评论
     */
    private void sendMailToParentComment(cn.ling.entity.Comment parentComment, CommentDTO commentDTO) {

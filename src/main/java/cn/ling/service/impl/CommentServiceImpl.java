...
import cn.ling.mapper.CommentMapper;
import cn.ling.model.dto.CommentDTO;
import cn.ling.model.temp.PostCommentDTO;
import cn.ling.model.vo.PageCommentVO;
import cn.ling.model.vo.PageResultVO;
import cn.ling.service.CommentService;
import cn.ling.service.MailService;
import cn.ling.util.JwtUtils;
import cn.ling.util.StringUtils;
import cn.ling.util.comment.CommentUtils;
...
public class CommentServiceImpl implements CommentService, AopProxy<CommentServiceImpl> {
     ...
     */
    private void judgeSendMail(CommentDTO commentDTO, boolean isVisitorComment, Comment parentComment) {
